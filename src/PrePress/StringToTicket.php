...
namespace arajcany\ToolBox\PrePress;

/**
 * Class StringToTicket
 * Extract from a string, data that can be used in DFE Job Tickets
 *
 * @package arajcany\ToolBox\PrePress
 */
class StringToTicket
{
    ...
    //output delimiters
    private $maxDelimiter;
    private $maxQualifier;
     ...
     * @return mixed
     */
    public function getMaxDelimiter()
    {
        return $this->maxDelimiter;
    }

    /**
     * @param mixed $maxDelimiter
     * @return StringToTicket
     */
    public function setMaxDelimiter($maxDelimiter)
    {
        $this->maxDelimiter = $maxDelimiter;
        return $this;
    }
     ...
     * @return mixed
     */
    public function getMaxQualifier()
    {
        return $this->maxQualifier;
    }

    /**
     * @param mixed $maxQualifier
     * @return StringToTicket
     */
    public function setMaxQualifier($maxQualifier)
    {
